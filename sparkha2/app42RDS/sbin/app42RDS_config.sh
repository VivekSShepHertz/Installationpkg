...
spark     soft    nproc     600000" >> /etc/security/limits.conf
	...
	/home/azureuser/Installationpkg/sparkha2/app42RDS/sbin/myconf qwertyuiop $lbip
	chmod +x /home/azureuser/Installationpkg/sparkha2/app42RDS/sbin/spark-env.sh
	cp /home/azureuser/Installationpkg/sparkha2/app42RDS/sbin/spark-env.sh /etc/spark/conf/.
