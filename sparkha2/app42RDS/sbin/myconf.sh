...
export SPARK_LOG_DIR=/var/lib/spark/logs
export SPARK_PID_DIR='/var/run/spark/'

export SPARK_DAEMON_JAVA_OPTS=\"-Dspark.deploy.recoveryMode=ZOOKEEPER -Dspark.deploy.zookeeper.url=10.20.1.5:2181,10.20.1.6:2181\"
...
SPARK_DIST_CLASSPATH=\"\$SPARK_DIST_CLASSPATH:/usr/lib/avro/*\" " > /home/azureuser/Installationpkg/sparkha2/app42RDS/sbin/spark-env.sh
