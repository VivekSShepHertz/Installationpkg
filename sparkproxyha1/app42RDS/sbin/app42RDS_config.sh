...
haproxy     soft    nproc     600000" >> /etc/security/limits.conf
	...
	/home/azureuser/Installationpkg/sparkproxyha1/app42RDS/sbin/myconf qwertyuiop $lbip
	cp /home/azureuser/Installationpkg/sparkproxyha1/app42RDS/sbin/haproxy.cfg /etc/haproxy/.
	cp /home/azureuser/Installationpkg/sparkproxyha1/app42RDS/sbin/zoo.cfg /etc/zookeeper/conf/.
