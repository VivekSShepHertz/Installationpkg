...
server.2=10.20.1.6:2888:3888" > /home/azureuser/Installationpkg/sparkproxyha1/app42RDS/sbin/zoo.cfg
...
backend haproxy_in
    ...
    server web02 10.20.1.8:8080 check" > /home/azureuser/Installationpkg/sparkproxyha1/app42RDS/sbin/haproxy.cfg
